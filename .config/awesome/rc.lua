...
netwidget = wibox.widget.textbox()
    ...
    vicious.register(netwidget, vicious.widgets.net, "NET: ${wlp1s0 up_kb} kb/s ${wlp1s0 down_kb} kb/s", 3)

wifiwidget = wibox.widget.textbox()
    wifiwidget.width, wifiwidget.align, wifiwidget.font = 100, "center", "Fira Code Retina 10"
    vicious.cache(vicious.widgets.wifi)
    vicious.register(wifiwidget, vicious.widgets.wifi, "${sign} ${linp}%", 3, "wlp1s0")

-- Battery widget
    mybattery = wibox.widget.textbox()
    mybattery.width, mybattery.align, mybattery.font = 100, "center", "Fira Code Retina 10"
    vicious.register(mybattery, vicious.widgets.bat, "BAT0: $2%", 15, "BAT0")
...
guimenu = "jgmenu_run"
deskmenu = "jgmenu --config-file=/home/doug/.config/jgmenu/jgmouserc"
Xterminal = "uxterm"
Sterminal = "st"
exitcmd = "rofi-logout"
...
appslauncher = awful.widget.launcher({ image = beautiful.awesome_icon,
                                     command = guimenu })
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    -- uncomment if wibox is wanted
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 28, type = "dock" })
...
root.buttons(gears.table.join(
    awful.button({ }, 1, function () awful.spawn(deskmenu) end),
    awful.button({ }, 3, function () mymainmenu:toggle() end)
    -- uncomment to enable workspace switch by scrolling
...
globalkeys = gears.table.join(
    ...
    awful.key({ altkey, "Shift"      }, "F2", function () awful.spawn(guimenu) end,
              {description = "open a menu", group = "launcher"}),

    awful.key({ modkey, "Control"      }, "l", function () awful.spawn(txteditor) end,
              {description = "open sublime", group = "launcher"}),
    awful.key({ modkey, "Control"      }, "g", function () awful.spawn(art) end,
              {description = "open gimp", group = "launcher"}),
    awful.key({ modkey, "Control"      }, "p", function () awful.spawn(ssheet) end,
              {description = "open spreadsheet", group = "launcher"}),
    awful.key({ modkey, "Control"      }, "o", function () awful.spawn(writer) end,
              {description = "open document", group = "launcher"}),
    awful.key({ modkey, "Control"      }, "Print", function () awful.spawn(screenshot) end,
              {description = "take a screenshot", group = "launcher"}),
    awful.key({ modkey, "Shift"        }, "q", function () awful.spawn(exitcmd) end,
              {description = "rofi logout command", group = "launcher"}),
