...
font1="DejaVu Markup:style=Book:size=10:antialias=true:hintstyle=slight"
font2="DejaVu Sans Mono:size=10:book:antialias=true:hintstyle=slight"
font3="FantasqueSansMono NF:size=18:regular:antialias=true:hintstyle=slight"
